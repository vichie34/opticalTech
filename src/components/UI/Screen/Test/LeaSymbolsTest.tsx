...
export const LeaSymbolsTest = ({ onComplete }: LeaSymbolsTestProps): JSX.Element => {
    const [time, setTime] = useState(0);
    const [isTracking, setIsTracking] = useState(false);
    const [currentSymbol, setCurrentSymbol] = useState("Circle");
                    ...
                    <CardContent className="flex items-center justify-between p-4">
                        ...
                        <div className="flex flex-col items-start justify-center">
                            <p className="font-medium text-[#0f3a98] text-sm leading-[21px] whitespace-nowrap font-['Outfit',Helvetica]">
                                Say the symbol you see out loud
                            </p>
