...
export const ContrastSensitivityTest = ({ onComplete }: ContrastSensitivityTestProps): JSX.Element => {
    ...
    const sendTestResult = async (_result: { score: number; distance: number }) => {
        try {
            ...
            await fetch(`${import.meta.env.VITE_API_BASE_URL}api/v1/test/contrast-sensitivity-test`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
        ...
        <div className="relative w-full max-w-[375px] h-[512px] bg-[#f9f9f9] lg:hidden">
            ...
            <main className="w-full h-full mt-[14px] bg-white">
                ...
                <div className="flex flex-col items-center justify-center mt-[62px]">
                    <h1
                        className="font-bold text-black text-center font-['Outfit',Helvetica] leading-normal transition-opacity duration-1000 blurred-text"
